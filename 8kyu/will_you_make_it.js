...
50 miles away! You know that on average, your car runs on about 25 miles per gallon.
...
true (1 in Prolog) if it is possible and false (0 in Prolog) if not.
The input values are always positive.
*/

const milesToPump = (milesToGo, mpg, fuelLeft) => {
    if (milesToGo <= (mpg * fuelLeft)) {
        return 1;
    }
    return 0;
}
